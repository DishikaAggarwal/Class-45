...
var xval=50;
var yval=50;
var bluegroup,greengroup,redgroup,purplegroup,orangegroup,allgroup,shooter;
ballarr=[],mainarr=[];
...
function preload ()
{
        ...
        redimg=loadImage("images/redball.png");
        purpleimg=loadImage("images/purpleball.png");
        orangeimg=loadImage("images/orangeball.png");
}
...
function ballselect(ball,rand)
{
        switch(rand)
        {
          ...
          case 2: ball.addImage(greenimg);
                  ball.scale=0.12;
                  break;
          case 3: ball.addImage(redimg);
                  ball.scale=0.27;
                  break;
          case 4: ball.addImage(purpleimg);
                  ball.scale=0.15;
                  break;
          case 5: ball.addImage(orangeimg);
                  ball.scale=0.15;
                  break;
